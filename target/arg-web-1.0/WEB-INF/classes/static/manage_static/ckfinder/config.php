...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,flv,pdf',
		'deniedExtensions' => '7z,aiff,asf,avi,csv,doc,docx,fla,gz,gzip,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '',
		'deniedExtensions' => 'flv');
		//'deniedExtensions' => 'swf,flv');
