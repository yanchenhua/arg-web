            ...
            data: function() {
                ...
                if ( this.data.src ) {
                    ...
                    if ( !this.element.getChild( 0 ) ) {
                        ...
                        this.element.append( videoElement ).append(source);
                    }
                    this.element.getChild( 0 ).setAttribute( 'src', this.data.src);
                    console.info(this.data.src)
                    this.element.getChild( 0 ).getChild( 0 ).setAttribute( 'src', this.data.src );
                    this.element.getChild( 0 ).getChild( 0 ).setAttribute( 'type', 'video/mp4' );
