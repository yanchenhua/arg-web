...
public enum LocaleMapConstants {
       cn("中文"), en("English"), ru("Русский язык"), zh_cn("中文"), en_us("English"), CN("中文"), EN("English"), RU("Русский язык"), zh_CN("中文"), en_US("English"), fr_FR("Français"), jp_JP("日本語") ,kr_KR("한국어") ,de_DE("Deutsch") ,es_ES("Español") ,por_POR("Português");
